 ...
 * [**  ASP.NET Web API Claims Authorization with ASP.NET Identity 2.1 – Part 5 ] (http://bitoftech.net/2015/03/31/asp-net-web-api-claims-authorization-with-asp-net-identity-2-1/)
...
* Dot Blogs
  * 權限 
    * https://dotblogs.com.tw/kevintan1983/2014/03/09/144308
     * https://dotblogs.com.tw/kevintan1983/2014/03/21/144463
   
* Blog
 * Refresh Token [Refresh Token] (https://dotblogs.com.tw/rainmaker/2015/03/02/150607)
 * Refresh Token [Adding Refresh Tokens to a Web API v2 Authorization Server] (https://leastprivilege.com/2013/11/15/adding-refresh-tokens-to-a-web-api-v2-authorization-server/)
 ...
 * [Code-First Migration and Extending Identity Accounts in ASP.NET MVC 5 and Visual Studio 2013](http://www.codeproject.com/Articles/674760/Code-First-Migration-and-Extending-Identity-Accoun)
  * [ASP.NET Identity 2.0: Introduction to Working with Identity 2.0 and Web API 2.2](http://www.codeproject.com/Articles/823263/ASP-NET-Identity-Introduction-to-Working-with-Iden#Identity-Configuration)
 ...
 * [Claim Based]  http://stackoverflow.com/questions/27898235/authorization-with-oauth-bearer-token-provided-by-external-web-api
 
### MS Data
 * ** Secutrity Filter https://msdn.microsoft.com/en-us/magazine/dn781361.aspx
 ...
 * https://github.com/hahalin/SPA-with-AngularJS
 * https://github.com/hahalin/angular2-authentication-sample

 
* Stackoverflow
 * http://stackoverflow.com/questions/25071817/owin-bearer-token-authentication-authorize-controller?rq=1
 * ajax + token in header
   * http://stackoverflow.com/questions/29510765/sending-oauth-access-token-in-jquery-ajax-request
   * http://stackoverflow.com/questions/19361908/ajaxsetup-beforesend-not-working
   * http://stackoverflow.com/questions/27990010/authorization-header-appended-only-once-in-ajax-cors-request
   * http://stackoverflow.com/questions/29228329/ajax-oauth-2-0-access-token
...
* Swagger 
  * http://blog.kkbruce.net/2015/04/aspnet-web-api-2-swagger.html#.V_aZK_l97X7
  * http://www.janaks.com.np/adding-swagger-asp-net-core-web-api/
...
* Blog
  ...
  * Azure https://azure.microsoft.com/zh-tw/documentation/articles/app-service-api-dotnet-get-started/
 ...
 * http://stackoverflow.com/questions/21616951/get-the-current-user-within-an-apicontroller-action-without-passing-the-userid
 * http://stackoverflow.com/questions/15148050/custom-authorizations-in-web-api
